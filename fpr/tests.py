...
from fpr.models import (
    Format, FormatGroup, FormatVersion,
    FPCommand, FPRule, FPTool,
    IDCommand, IDTool
)
...
class TestViews(TestCase):
    ...
    def test_idcommand_create(self):
        ...
        tool = IDTool.objects.create(
            uuid='37f3bd7c-bb24-4899-b7c4-785ff1c764ac',
            description='Foobar', version='v1.2.3')
...
class TestForms(TestCase):
    ...
    def create_fprule(self):
        ...
        cmd = FPCommand.objects.create(
            uuid='223a24cd-6697-4361-b8e7-72d081319a84')
        return FPRule.objects.create(
            uuid='37f3bd7c-bb24-4899-b7c4-785ff1c764ac',
            purpose='validation', format=fmt_version, command=cmd)
